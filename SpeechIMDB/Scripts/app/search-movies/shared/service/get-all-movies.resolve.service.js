...
var GetAllMoviesResolve = (function () {
    function GetAllMoviesResolve(searchMovieParameterService, movieService, moviePromiseService, loaderService) {
    ...
    GetAllMoviesResolve = __decorate([
        core_1.Injectable(), 
        __metadata('design:paramtypes', [search_movie_parameter_store_service_1.SearchMovieParameterDataService, web_api_observable_service_1.WebApiObservableService, web_api_promise_service_1.WebApiPromiseService, loader_service_1.LoaderService])
    ], GetAllMoviesResolve);
